...
public class Scene8Dialogue : MonoBehaviour
{
    ...
    public void Next()
    {
        ...
        else if (primeInt == 2)
        {
            ...
            Char1name.text = "";
            StartCoroutine(TypeText(Char1speech, "新学期、４月"));
            Char2name.text = "";
            Char2speech.text = "";
        }
        else if (primeInt == 3)
        ...
        else if (primeInt == 4)
        {
            ...
            Char1speech.text = "";
            Char2name.text = "秋山 武";
            StartCoroutine(TypeText(Char2speech, "よ、まこと! 同じクラスだな。"));
        }
        else if (primeInt == 5)
        {
            ...
            StartCoroutine(TypeText(Char1speech, "おはよう、たけし! 今年もよろしくね!"));
            Char2name.text = "";
            Char2speech.text = "";
        }
        else if (primeInt == 6)
        {
            Char1name.text = "";
            StartCoroutine(TypeText(Char1speech, "キンコーン カンコーン!"));
            Char2name.text = "";
            Char2speech.text = "";
        }
        else if (primeInt == 7)
        ...
        else if (primeInt == 9)
        {
            ArtMakoto_d.SetActive(false);
            ArtTakeshiR_d.SetActive(false);
            StartCoroutine(FadeIn(ArtAyase_b));
            ArtAyase_b.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "";
            Char2name.text = "立花 あやせ";
            StartCoroutine(TypeText(Char2speech, "おはよう、みんな! 立花あやせで〜す!"));
        }
        else if (primeInt == 10)
        {
            ArtAyase_b.SetActive(false);
            ...
            Char1speech.text = "";
            Char2name.text = "立花 あやせ";
            StartCoroutine(TypeText(Char2speech, "今日から私が担任になりますよ! よろしくね〜〜 ★"));
        }
        else if (primeInt == 11)
        {
            ArtMakoto_d.SetActive(true);
            ...
            ArtAyase_a.SetActive(false);
            Char1name.text = "まこと/武";
            StartCoroutine(TypeText(Char1speech, "はあああ!?"));
            Char2name.text = "";
            Char2speech.text = "";
        }
        else if (primeInt == 12)
        {
            Char1name.text = "";
            StartCoroutine(TypeText(Char1speech, "つづく…"));
            Char2name.text = "";
            Char2speech.text = "";
        }
        else if (primeInt == 13)
